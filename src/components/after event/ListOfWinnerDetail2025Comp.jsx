    ...
    return(
        ...
        <section className="low-detail-after-event-section" id="low-detail-after-event">
            <div className="low-detail-after-event-heading">
                <h1 className="section-header">After Event IYBO 2025</h1>
            </div>
            <div className="low-detail-after-event-container">
                <div className="low-detail-after-event-row">
                    ...
                    <div className="low-detail-after-event-video">
                        <iframe className="mt-5"  width="100%" height="315" src="https://www.youtube.com/embed/qMS8JGYShT0?si=Fj_K015K1cLU63Mr" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                    </div>
            ...
            <div className="low-detail-document-container">
                ...
                <div className="serviceBox">
                    ...
                    <div className="content">
                        ...
                        <br />
                        <a href="https://drive.google.com/file/d/1gXgYEasVsKV4SWsq3hbl307qlILE4KBY/view?usp=sharing" target="_blank" className="low-detail-document-button">Download</a>
                    </div>
                </div>
                ...
                <div className="serviceBox">
                    ...
                    <div className="content">
                        <h2>Kurasi</h2>
                        <br />
                        <a href="https://drive.google.com/drive/folders/1OtPQULlba4DFS5OeiOUkLvSDELngdHpc?usp=sharing" target="_blank" className="low-detail-document-button">Download</a>
                    </div>
                </div>
        ...
        <section className="head-low-detail-document-section" id="head-low-detail-document">
            ...
            <div className="low-press-release-button-container">
                <a href="https://drive.google.com/file/d/1xtNRUdpRV1YpfkqCYINwnbG83y-La-bU/view?usp=sharing" className="low-press-release-button">Download Press Release</a>
            </div>
        </section>
        <br />
        </>
