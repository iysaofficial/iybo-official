    ...
    return(
        ...
        <section className="low-detail-after-event-section" id="low-detail-after-event">
            <div className="low-detail-after-event-heading">
                <h1 className="section-header">After Event IYBO 2024</h1>
            </div>
            <div className="low-detail-after-event-container">
                <div className="low-detail-after-event-row">
                    ...
                    <div className="low-detail-after-event-video">
                        <iframe className="mt-5"  width="100%" height="315" src="https://www.youtube.com/embed/FhIGkP87BZ4?si=wPRxbWiMOUNCf07P" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                    </div>
            ...
            <div className="low-detail-document-container">
                ...
                <div className="serviceBox">
                    ...
                    <div className="content">
                        ...
                        <br />
                        <a href="https://drive.google.com/file/d/1H6Sq8RTedOVvFv1en4GuGO20iSmzJizO/view?usp=sharing" target="_blank" className="low-detail-document-button">Download</a>
                    </div>
                </div>
                ...
                {/* <div className="serviceBox">
                    ...
                    <div className="content">
                        ...
                        <br />
                        <a href="https://drive.google.com/file/d/1fFAxqs7Fha5D-kCnZaKGieVAf-AyADZv/view?usp=sharing" target="_blank" className="low-detail-document-button">Download</a>
                    </div>
                </div> */}
                ...
                <div className="serviceBox">
                    ...
                    <div className="content">
                        <h2>Curation</h2>
                        <br />
                        <a href="https://drive.google.com/drive/u/0/folders/1O4S3oK1QCl7mNLrI3vyq5KnuRvWMUbpq" target="_blank" className="low-detail-document-button">Download</a>
                    </div>
                </div>
        ...
        <section className="head-low-detail-document-section" id="head-low-detail-document">
            ...
            <section class="low-press-release-section">
                <div class="low-press-release-container">
                    <div class="low-press-release-wrapper">

                    <iframe src="https://drive.google.com/file/d/18dkpe3f-rHJnmxn4YBWy7EpZjfi5EhJk/preview"></iframe>
                    
                    </div>
                </div>
            </section>
            <div className="low-press-release-button-container">
                <a href="https://drive.google.com/file/d/18dkpe3f-rHJnmxn4YBWy7EpZjfi5EhJk/view?usp=sharing" className="low-press-release-button">Download Press Release</a>
            </div>
        </section>
        <br />
        </>
